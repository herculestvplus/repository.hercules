...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]:::[/COLOR][COLOR white]BEM-VINDOS AO ADDON[/COLOR][COLOR white]:::[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
...
desc_configuracoes = 'Configure o addon conforme desejado Desativando ou ativando as notificações e muito mais.'
## FAVORITOS
...
url_origem = 'https://raw.githubusercontent.com/herculestvplus/addon/refs/heads/main/menu_principal.txt'
try:
